...
export default function Home() {
  ...
  const fetchSignals = React.useCallback(() => {
    ...
    fetch(`${API_BASE}/api/signals`, {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6ImEwYjBjMzRlODIyN2ZjMDJkMGU0OWY5YWZiNWFkM2VhODEwODcyMWIifQ..ozOFdrHDxAb5wfvZFwZiNCT3DiIVWzZVl82P2aro8ApXIjYRKZr_Zm36778ayecPplkaOnSMjRdS54c9TgrMyjTDLv4hX1NVMDwUxmdAMmcaE4DT7u7yI3rJlL9jLuoxwJ1R0C-wlX76a033IV7VIigB2a3z9BTqCCy7PevKsXY8g3IVr8IZKE8f_wxfKMTrF8CHyLoX4cLU7es586auUEoGf8lygWcWP17cWvrYPMhN3v5Z72i48ts6UiIh_MEPIsR8DxM_1MazdU2yzxJYsIFMTt5mM82f9HUXyu4J4d9-5AZbm0aTDPPIVAh_izHc73zrWxGAtrT9qAueKyfXvQ'
      },
    })
      .then((r) => {
