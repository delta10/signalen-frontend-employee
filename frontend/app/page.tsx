...
export default function Home() {
  ...
  const fetchSignals = React.useCallback(() => {
    ...
    fetch(`${API_BASE}/api/signals`, {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6ImEwYjBjMzRlODIyN2ZjMDJkMGU0OWY5YWZiNWFkM2VhODEwODcyMWIifQ..WzF6mKLeD-VBXocFzAlTmfNvx9eAUFN6o8UaDTaUlc1lyy_KmpNMs-T3s4lgpomhOceFGPhKQVQYmTHbCwyC_DxERZsqXs1NpDK_nXtToeQuDXM1IkEhuO0EBxIfCQvhhYKaKTqQVr53RLwXngbuKj2uZJ13sGx53MXYBTqW-PkueFa_H6JpaJo229FDwuF5MvsLKuCWXIuaaFeug91lkZpxnHyHmXL63WKKimsX8ez8yUY9cipwuinkVECZkYnSZTexMVeALA2fgy6JKcY-GJ03KCInNr-KsRYIReTtfi9Kt1miVIokt6_YgzImyPSy6PtJemnF1E_0QeQdaw29ew'
      },
    })
      .then((r) => {
