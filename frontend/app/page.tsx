...
export default function Home() {
  ...
  const fetchSignals = React.useCallback(() => {
    ...
    fetch(`${API_BASE}/api/signals`, {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjBhZDhjMTlhY2MzZGYzYTEwYjEwYjI3MTdiZTllMjFiNTVjOWE3NzcifQ.._50WxpLLdpjr5Rr9dvNWUqoGQ'
      },
    })
      .then((r) => {
  ...
  // const handleViewReport = (signal: Signal) => {
  // router.push(`/manage/incident/${signal.id}`);
  // };
              ...
              <Table>
                ...
                <TableBody>
                  {filtered.map((s: any) => {
                    ...
                    const path = `/manage/incident/${displayId}`;
