...
import { Report, Note, StatusHistory, SubMelding } from '../data/mockData';
...
export function ReportDetailSheet({ report, isOpen, onClose, onUpdateReport }: ReportDetailSheetProps) {
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-3 mb-2">
                  {report.mainReportId && (
                    <Badge variant="outline" className="text-xs font-medium">
                      Hoofdmelding {report.mainReportId}
                    </Badge>
                  )}
                  <Badge className="text-xs">
                    {report.category || 'Overlast'}
                  </Badge>
                  <span className="text-xs text-muted-foreground">
                    {formatDate(report.createdAt)}
                  </span>
                  <div className="flex gap-1">
                    <Button variant="outline" size="sm" className="h-7 px-2 text-xs">Delen</Button>
                    <Button variant="outline" size="sm" className="h-7 px-2 text-xs">Extern</Button>
                    <Button variant="outline" size="sm" className="h-7 px-2 text-xs">PDF</Button>
                  </div>
                </div>
                ...
                <SheetDescription className="sr-only">
                  Melding details voor {report.title}
                </SheetDescription>
              </div>
            </div>
          </SheetHeader>
                ...
                <Card>
                  <CardContent className="p-4">
                    ...
                    {isEditing ? (
                      ...
                      <Badge className={statusColors[status] || statusColors['Nieuw']} variant="default">
                        {status}
                      </Badge>
                    )}
                  </CardContent>
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-sm">
                        {report.subcategory || report.category || 'Niet gespecificeerd'}
                      </span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-1">{report.location.address}</p>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">{report.reporter.phone || 'Niet opgegeven'}</span>
                      </div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {report.mainCategory || 'Niet gecategoriseerd'}
                        </p>
                      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-6">
                ...
                <Card>
                  <CardContent className="p-3">
                    ...
                    <p className="text-xs">
                      {report.handlingTermDays !== undefined 
                        ? (report.handlingTermDays ? `${report.handlingTermDays} werkdagen` : 'null werkdagen')
                        : 'Niet gespecificeerd'
                      }
                    </p>
                  </CardContent>
                ...
                <Card>
                  <CardContent className="p-3">
                    ...
                    <p className="text-xs">{report.source || 'Onbekend'}</p>
                  </CardContent>
                </Card>
              </div>
